...
function SignIn() {
  ...
  return (
    <>
      <div className="h-screen flex font">
      ...
      <Nav menuItems={menu}/>
        ...
        <div className="md:w-1/2 sm:w-1/3 w-0 left h-screen flex justify-center items-center">
          <p className="text-4xl font-bold text-white text-center font-inter">
            NEW <br /> FAST <br />
            STRONG
          </p>
        </div>
        <div className="md:w-1/2 sm:w-2/3 w-full right h-screen flex items-center lg:pl-28 p-5 justify-center">
          <form className="md:w-[350px] max-w-[500px] w-full h-110">
            <h4 className="text-white text-3xl font-bold mb-1 font-inter">
              Nice to see you!
            </h4>
            <p className="text-gray-400 font-normal mb-9 font-inter">
              Enter your email and password to sign in
            </p>
            <label className="text-white" htmlFor="email font-inter">
              Email
            </label>{" "}
            <br />
            <input
              className="mt-1 w-full px-6 py-2.5 text-white  placeholder-gray-400 bg-[#0F123B] focue:bg-[#0F123B] border-2 border-transparent bg-none mb-6 outline-none focus:outline-none"
              type="email"
              id="email"
            ...
            <div className="flex items-center justify-between mb-9">
              ...
              <p className="text-[#A0AEC0]">
                <a className="text-[#0075FF] font-inter" href="#">AGREE</a> WITH ALL RULES
              </p>
            </div>
            <button className="w-full h-11 bg-[#0075FF] rounded-2xl text-white cursor-pointer font-bold mb-5">SIGN IN</button>
            <a className="text-[#A0AEC0] text-center items-center font-inter" href="">
